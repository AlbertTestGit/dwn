...
class restly_nft_products_Widget extends Widget_Base {
    ...
    public function get_name() {
        ...
        return 'restly_nft_products';
    }

    public function get_title() {
        return esc_html__( 'Restly NFT Products', 'restlycore' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'restly_nft_product_by_cat',
            [
                'label' => esc_html__( 'Select Category', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::SELECT2,
                'multiple' => true,
                'options' => restly_woo_cat_id(),
                'condition' => [
                    'restly_nft_cat_enable' => 'yes',
                ],
            ]
        );
        $this->add_control(
            'restly_nft_product_orderby',
            [
        ...
        $this->add_control(
            'restly_nft_product_price_label',
            [
        ...
        $this->start_controls_section(
            'restly_nft_products_settings',
            [
                'label' => esc_html__( 'Product Settings', 'restlycore' ),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control(
            'restly_nft_prodcut_slide_enable',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 6,
                'condition' => [
                    'restly_nft_prodcut_slide_enable!' => 'yes',
                ],
            ]
        );
        $this->add_control(
            'restly_nft_prodcut_loop',
            [
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'restly_nft_products_hadding_settings',
            [
        ...
        $this->start_controls_tabs(
            'restly_action_actions_tabs'
        );
        $this->start_controls_tab(
            'restly_actions_tabs_stitle',
            [
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'restly_section_saction_typo',
                'label' => esc_html__( 'Typography', 'restlycore' ),
                'selector' => '{{WRAPPER}} .nft-active-top-nav span.sub-title',
            ]
        );
        $this->add_responsive_control(
            'restly_section_saction_color',
            [
        ...
        $this->add_responsive_control(
            'restly_section_saction_padding',
            [
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name' => 'restly_section_action_typo',
                'label' => esc_html__( 'Typography', 'restlycore' ),
                'selector' => '{{WRAPPER}} .nft-active-top-nav .title',
            ]
        );
        $this->add_responsive_control(
            'restly_section_action_color',
            [
                'label' => esc_html__( 'Color', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'restly_nft_product_item_css_box',
            [
            ...
            $this->start_controls_tabs(
                'restly_nft_product_item_box_tabs'
            );
                $this->start_controls_tab(
                    'restly_nft_product_item_box_tabs_normal',
                    [
                        'label' => __( 'Normal', 'restlycore' ),
                    ]
                );
                $this->add_responsive_control(
                    'restly_nft_product_item_box_aligment',
                    [
                        'label' => __( 'Alignment', 'restlycore' ),
                        'type' => \Elementor\Controls_Manager::CHOOSE,
                        'options' => [
                ...
                $this->add_group_control(
                    ...
                    [
                        'name' => 'restly_nft_product_item_box_bg',
                ...
                $this->add_group_control(
                    ...
                    [
                        'name' => 'restly_nft_product_item_box_border',
                ...
                $this->add_group_control(
                    ...
                    [
                        'name' => 'restly_nft_product_item_box_shadow',
                        'label' => esc_html__( 'Box Shadow', 'restlycore' ),
                        'selector' => '{{WRAPPER}} .actions-active .action-item',
                    ]
                );
                $this->add_responsive_control(
                    'restly_nft_product_item_box_radius',
                    [
                ...
                $this->add_responsive_control(
                    'restly_nft_product_item_box_margin',
                    [
                        'label' => esc_html__( 'Margin', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->add_responsive_control(
                    'restly_nft_product_item_box_padding',
                    [
                        'label' => esc_html__( 'Padding', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->start_controls_tab(
                    'restly_nft_product_item_box_tabs_hover',
                    [
                ...
                $this->add_group_control(
                    \Elementor\Group_Control_Background::get_type(),
                    [
                        'name' => 'restly_nft_product_item_box_hbg',
                        'label' => esc_html__( 'Background', 'restlycore' ),
                        'types' => [ 'classic', 'gradient', 'video' ],
                ...
                $this->add_group_control(
                    \Elementor\Group_Control_Border::get_type(),
                    [
                        'name' => 'restly_nft_product_item_box_hborder',
                        'label' => esc_html__( 'Border', 'restlycore' ),
                        'selector' => '{{WRAPPER}} .actions-active .action-item:hover',
                    ]
                );
                $this->add_group_control(
                    \Elementor\Group_Control_Box_Shadow::get_type(),
                    [
                        'name' => 'restly_nft_product_item_box_hshadow',
                        'label' => esc_html__( 'Box Shadow', 'restlycore' ),
                        'selector' => '{{WRAPPER}} .actions-active .action-item:hover',
                    ]
                );
                $this->add_responsive_control(
                    'restly_nft_product_item_box_hradius',
                    [
                        'label' => esc_html__( 'Border Radius', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->start_controls_section(
            'restly_restly_nft_product_css_image',
            [
            ...
            $this->start_controls_tabs(
                'restly_restly_nft_product_css_image_tabs'
            );
                $this->start_controls_tab(
                    'restly_restly_nft_product_css_image_tabs_normal',
                    [
                        'label' => __( 'Normal', 'restlycore' ),
                    ]
                );
                $this->add_group_control(
                    \Elementor\Group_Control_Background::get_type(),
                    [
                        'name' => 'restly_nft_product_css_image_bg',
                        'label' => esc_html__( 'Background', 'restlycore' ),
                        'types' => [ 'classic', 'gradient', 'video' ],
                ...
                $this->add_responsive_control(
                    'restly_nft_product_css_image_height',
                    [
                ...
                $this->add_responsive_control(
                    'restly_nft_product_css_image_cover',
                    [
                ...
                $this->add_group_control(
                    \Elementor\Group_Control_Border::get_type(),
                    [
                        'name' => 'restly_nft_product_css_image_border',
                        'label' => esc_html__( 'Border', 'restlycore' ),
                        'selector' => '{{WRAPPER}} .action-item .image img',
                    ]
                );
                $this->add_responsive_control(
                    'restly_nft_product_css_image_radius',
                    [
                        'label' => esc_html__( 'Border Radius', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->add_group_control(
                    \Elementor\Group_Control_Box_Shadow::get_type(),
                    [
                        'name' => 'restly_nft_product_css_image_shadow',
                        'label' => esc_html__( 'Box Shadow', 'restlycore' ),
                        'selector' => '{{WRAPPER}} .action-item .image img',
                    ]
                );
                $this->add_responsive_control(
                    'restly_nft_product_css_image_margin',
                    [
                        'label' => esc_html__( 'Margin', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->add_responsive_control(
                    'restly_nft_product_css_image_padding',
                    [
                        'label' => esc_html__( 'Padding', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->start_controls_tab(
                    'restly_restly_nft_product_css_image_tabs_hover',
                    [
                        'label' => __( 'Hover', 'restlycore' ),
                    ]
                );
                $this->add_group_control(
                    \Elementor\Group_Control_Background::get_type(),
                    [
                        'name' => 'restly_nft_product_css_image_hbg',
                        'label' => esc_html__( 'Background', 'restlycore' ),
                        'types' => [ 'classic', 'gradient', 'video' ],
                ...
                $this->add_group_control(
                    \Elementor\Group_Control_Border::get_type(),
                    [
                        'name' => 'restly_nft_product_css_image_hborder',
                        'label' => esc_html__( 'Border', 'restlycore' ),
                        'selector' => '{{WRAPPER}} .action-item:hover .image img',
                    ]
                );
                $this->add_responsive_control(
                    'restly_nft_product_css_image_hradius',
                    [
                        'label' => esc_html__( 'Border Radius', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->add_group_control(
                    \Elementor\Group_Control_Box_Shadow::get_type(),
                    [
                        'name' => 'restly_nft_product_css_image_hshadow',
                        'label' => esc_html__( 'Box Shadow', 'restlycore' ),
                        'selector' => '{{WRAPPER}} .action-item:hover .image img',
                    ]
                );
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'restly_nft_product_content_css_box',
            [
            ...
            $this->start_controls_tabs(
                'restly_nft_product_conent_css_tabs'
            );
                $this->start_controls_tab(
                    'restly_nft_product_conent_css_tabs_title',
                    [
                        'label' => __( 'Title', 'restlycore' ),
                    ]
                );
                $this->add_group_control(
                    \Elementor\Group_Control_Typography::get_type(),
                    [
                        'name' => 'restly_nft_product_title_typo',
                        'label' => esc_html__( 'Typography', 'restlycore' ),
                        'selector' => '{{WRAPPER}} .nft-product-title',
                    ]
                );
                $this->add_responsive_control(
                    'restly_nft_product_title_color',
                    [
                        'label' => esc_html__( 'Color', 'restlycore' ),
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                ...
                $this->add_responsive_control(
                    'restly_nft_product_title_hcolor',
                    [
                ...
                $this->add_responsive_control(
                    'restly_nft_product_title_margin',
                    [
                        'label' => esc_html__( 'Margin', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->add_responsive_control(
                    'restly_nft_product_title_padding',
                    [
                        'label' => esc_html__( 'Padding', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->start_controls_tab(
                    'restly_nft_product_conent_css_tabs_price',
                    [
                ...
                $this->add_group_control(
                    \Elementor\Group_Control_Typography::get_type(),
                    [
                        'name' => 'restly_nft_product_price_typo',
                        'label' => esc_html__( 'Typography', 'restlycore' ),
                        'selector' => '{{WRAPPER}} .action-item .content .bid-dots .bid',
                    ]
                );
                $this->add_responsive_control(
                    'restly_nft_product_price_color',
                    [
                        'label' => esc_html__( 'Color', 'restlycore' ),
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                ...
                $this->add_responsive_control(
                    'restly_nft_product_price_hcolor',
                    [
                        'label' => esc_html__( 'Hover Color', 'restlycore' ),
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                ...
                $this->add_responsive_control(
                    'restly_nft_product_price_margin',
                    [
                        'label' => esc_html__( 'Margin', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->add_responsive_control(
                    'restly_nft_product_price_padding',
                    [
                        'label' => esc_html__( 'Padding', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->add_responsive_control(
                    'restly_nft_product_price_dot_c',
                    [
                ...
                $this->add_responsive_control(
                    'restly_nft_product_price_dot_bc',
                    [
                ...
                $this->end_controls_tab();
                $this->start_controls_tab(
                    'restly_nft_product_conent_css_tabs_img',
                    [
                ...
                $this->add_responsive_control(
                    'restly_nft_product_atitle_hcolor',
                    [
                        'label' => esc_html__( 'Hover Color', 'restlycore' ),
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                ...
                $this->add_responsive_control(
                    'restly_nft_product_atitle_margin',
                    [
                        'label' => esc_html__( 'Margin', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->add_responsive_control(
                    'restly_nft_product_atitle_padding',
                    [
                        'label' => esc_html__( 'Padding', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->add_group_control(
                    \Elementor\Group_Control_Typography::get_type(),
                    [
                        'name' => 'restly_nft_product_aroles_typo',
                        'label' => esc_html__( 'Typography', 'restlycore' ),
                        'selector' => '{{WRAPPER}} .action-item .content .author-wish .author span',
                    ]
                );
                $this->add_responsive_control(
                    'restly_nft_product_aroles_color',
                    [
                        'label' => esc_html__( 'Color', 'restlycore' ),
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                ...
                $this->add_responsive_control(
                    'restly_nft_product_aroles_hcolor',
                    [
                        'label' => esc_html__( 'Hover Color', 'restlycore' ),
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                ...
                $this->add_responsive_control(
                    'restly_nft_product_aroles_margin',
                    [
                        'label' => esc_html__( 'Margin', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->add_responsive_control(
                    'restly_nft_product_aroles_padding',
                    [
                        'label' => esc_html__( 'Padding', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->add_responsive_control(
                    'restly_nft_product_img_padding',
                    [
                        'label' => esc_html__( 'Padding', 'restlycore' ),
                        'type' => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'restly_action_CSS_timer_options',
            [
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'restly_action_timer_box_bg',
                'label' => esc_html__( 'Background', 'restlycore' ),
                'types' => [ 'classic', 'gradient', 'video' ],
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
            [
                'name' => 'restly_action_timer_box_border',
                'label' => esc_html__( 'Border', 'restlycore' ),
                'selector' => '{{WRAPPER}} .action-item .image .count-down',
            ]
        );
        $this->add_responsive_control(
            'restly_action_timer_box_radius',
            [
                'label' => esc_html__( 'Border Radius', 'restlycore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Box_Shadow::get_type(),
            [
                'name' => 'restly_action_timer_box_shadow',
                'label' => esc_html__( 'Box Shadow', 'restlycore' ),
                'selector' => '{{WRAPPER}} .action-item .image .count-down',
            ]
        );
        $this->add_responsive_control(
            'restly_action_timer_box_margin',
            [
                'label' => esc_html__( 'Margin', 'restlycore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_responsive_control(
            'restly_action_timer_box_padding',
            [
                'label' => esc_html__( 'Padding', 'restlycore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->start_controls_tabs(
            'restly_action_timer_css_tabs'
        );
        $this->start_controls_tab(
            'restly_action_timer_css_tabs_number',
            [
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name' => 'restly_action_timer_number_typo',
                'label' => esc_html__( 'Typography', 'restlycore' ),
                'selector' => '{{WRAPPER}} .action-item .image .count-down li span',
            ]
        );
        $this->add_responsive_control(
            'restly_action_timer_number_c',
            [
                'label' => esc_html__( 'Color', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'restly_action_timer_number_margin',
            [
                'label' => esc_html__( 'Margin', 'restlycore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_responsive_control(
            'restly_action_timer_number_padding',
            [
                'label' => esc_html__( 'Padding', 'restlycore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->start_controls_tab(
            'restly_action_timer_css_tabs_hover',
            [
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name' => 'restly_action_timer_text_typo',
                'label' => esc_html__( 'Typography', 'restlycore' ),
                'selector' => '{{WRAPPER}} .action-item .image .count-down li',
            ]
        );
        $this->add_responsive_control(
            'restly_action_timer_text_c',
            [
                'label' => esc_html__( 'Color', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'restly_action_timer_text_margin',
            [
                'label' => esc_html__( 'Margin', 'restlycore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_responsive_control(
            'restly_action_timer_text_padding',
            [
                'label' => esc_html__( 'Padding', 'restlycore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'restly_action_CSS_arrow_options',
            [
        ...
        $this->start_controls_tabs(
            'restly_action_CSS_arrow_tabs'
        );
        $this->start_controls_tab(
            'restly_action_CSS_arrow_tabs_Dot',
            [
                'label' => __( 'Dot', 'restlycore' ),
            ]
        );
        $this->add_responsive_control(
            'restly_action_CSS_arrow_dot_aligment',
            [
                'label' => __( 'Alignment', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
        ...
        $this->add_responsive_control(
            'action_CSS_arrow_dot_color',
            [
                'label' => esc_html__( 'background Color', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .actions-active ul.slick-dots li button' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            'action_CSS_arrow_dot_acolor',
            [
        ...
        $this->start_controls_tab(
            'restly_action_CSS_arrow_tabs_nav',
            [
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'restly_action_CSS_arrow_background',
                'label' => esc_html__( 'Background', 'restlycore' ),
                'types' => [ 'classic', 'gradient', 'video' ],
        ...
        $this->add_responsive_control(
            'restly_action_CSS_arrow_height',
            [
                'label' => esc_html__( 'Height', 'restlycore' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
            [
                'name' => 'restly_action_CSS_arrow_border',
                'label' => esc_html__( 'Border', 'restlycore' ),
                'selector' => '{{WRAPPER}} .actions-arrow-btns .slick-arrow',
            ]
        );
        $this->add_responsive_control(
            'restly_action_CSS_arrow_radius',
            [
                'label' => esc_html__( 'Border Radius', 'restlycore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Box_Shadow::get_type(),
            [
                'name' => 'restly_action_CSS_arrow_shadow',
                'label' => esc_html__( 'Shadow', 'restlycore' ),
                'selector' => '{{WRAPPER}} .actions-arrow-btns .slick-arrow',
            ]
        );
        $this->add_responsive_control(
            'restly_action_CSS_arrow_margin',
            [
                'label' => esc_html__( 'Margin', 'restlycore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_responsive_control(
            'restly_action_CSS_arrow_padding',
            [
                'label' => esc_html__( 'Padding', 'restlycore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'restly_action_CSS_arrow_hbackground',
                'label' => esc_html__( 'Background', 'restlycore' ),
        ...
        $this->add_responsive_control(
            'restly_action_CSS_arrow_hcolor',
            [
                'label' => esc_html__( 'Color', 'restlycore' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
            [
                'name' => 'restly_action_CSS_arrow_hborder',
                'label' => esc_html__( 'Border', 'restlycore' ),
                'selector' => '{{WRAPPER}} .actions-arrow-btns .slick-arrow:hover',
            ]
        );
        $this->add_responsive_control(
            'restly_action_CSS_arrow_hradius',
            [
                'label' => esc_html__( 'Border Radius', 'restlycore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Box_Shadow::get_type(),
            [
                'name' => 'restly_action_CSS_arrow_hshadow',
                'label' => esc_html__( 'Shadow', 'restlycore' ),
                'selector' => '{{WRAPPER}} .actions-arrow-btns .slick-arrow:hover',
            ]
        );
    ...
    protected function render() {
        ...
        if($settings['restly_nft_prodcut_slide_enable'] == 'yes'){
            echo '
            <script>
                jQuery(document).ready(function($) {
                    "use strict";
                    if ($("#actions-active-'.esc_attr($uniqe).'").length) {
                        $("#actions-active-'.esc_attr($uniqe).'").slick({
                            rtl: '.json_encode( is_rtl() == 'yes' ? true : false).',
                            dots: '.json_encode($settings['restly_nft_product_dot'] == 'yes' ? true : false).',
                            infinite: '.json_encode($settings['restly_nft_prodcut_loop'] == 'yes' ? true : false).',
                            autoplay: '.json_encode($settings['restly_nft_product_aloop'] == 'yes' ? true : false).',
                            autoplaySpeed: '.json_encode($settings['restly_nft_product_aspeed']).',
                            arrows: '.json_encode($settings['restly_nft_prodcut_nav'] == 'yes' ? true : false).',
                            prevArrow: $(".action-prev"),
                            nextArrow: $(".action-next"),
                            centerMode: false,
                            speed: '.json_encode($settings['restly_nft_product_speed']).',
                            slidesToShow: 4,
                            slidesToScroll: 2,
                            responsive: [
                                {
            ...
            $row = 'actions-active no-row';
            $col = 'no-col';
            $nav_row = 'col-xl-6 col-lg-8 col-md-8 col-12';
            $items = -1;
        }else{
            $row = 'actions-active row';
            $col = 'col-xl-'.$settings['restly_nft_product_column'].' col-lg-4 col-sm-6';
            $nav_row = 'col-xl-12 col-lg-12 col-md-12 col-12';
            $items = $settings['restly_nft_prodcuts_show'];
        }
        // Products Query
        global $product;
        $paged = get_query_var('paged') ? get_query_var('paged') : 1;
        if($settings['restly_nft_cat_enable'] == 'yes'){
            $p = new \WP_Query( array( 
                'posts_per_page' => $items,
                'post_type' => 'product',
                'paged'     => $paged,
                'orderby'     => esc_attr($settings['restly_nft_product_orderby']),
                'order'     => esc_attr($settings['restly_nft_product_order']),
                'tax_query' => array(
                    array(
                        'taxonomy' => 'product_cat',
                        'field' => 'term_id',
                        'terms' => $settings['restly_nft_product_by_cat'],
                    )
                ),
            ));
        }else{
        ...
        <div class="nft-actions-wrapper">
            <div class="nft-active-top-nav">
                <div class="row align-items-center">
                    <div class="<?php echo esc_attr($nav_row); ?>">
                        <div class="section-title mb-20">
                            <?php if($settings['restly_nft_pro_stitle']){
                                echo '<span class="sub-title">'.esc_html($settings['restly_nft_pro_stitle']).'</span>';
                            }?>
                            <?php if($settings['restly_nft_pro_stitle']){
                                echo '<'.esc_attr($settings['restly_nft_pro_title_tag']).' class="title">'. wp_kses_post($settings['restly_nft_pro_title']) .'</'.esc_attr($settings['restly_nft_pro_title_tag']).'>';
                            }?>
                        </div>
                    </div>
                    <?php if( $settings['restly_nft_prodcut_slide_enable'] == 'yes' && $settings['restly_nft_prodcut_nav'] == 'yes') : ?>
                    <div class="col-xl-6 col-lg-4">
                        <div class="actions-arrow-btns text-lg-right mb-30">
                            <button class="action-prev"><i class="fas fa-arrow-left"></i></button>
                            <button class="action-next"><i class="fas fa-arrow-right"></i></button>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            <div class="<?php echo esc_attr($row); ?>" id="actions-active-<?php echo esc_attr($uniqe); ?>">
                ...
                $user_roles = get_author_role();
                $disply_roles = str_replace("_", " ", $user_roles);
                ?>
                <div <?php wc_product_class( 'nft-item '.esc_attr($col).'', $product ); ?>>
                    <div class="action-item">
                        <div class="image">
                            <?php the_post_thumbnail('full', array('class' => 'img-responsive')); ?>
                            <?php if($sales_price_to != "" && $settings['restly_nft_product_timer'] == 'yes' ) : ?>
                        ...
                        <div class="content">
                            <div class="bid-dots">
                                <div class="bid"><?php echo esc_html($settings['restly_nft_product_price_label']); ?><b><?php woocommerce_template_loop_price(); ?></b></div>
                ...
                <?php if($settings['restly_nft_prodcut_pagination'] == 'yes' ) { ?>
...
Plugin::instance()->widgets_manager->register( new restly_nft_products_Widget );